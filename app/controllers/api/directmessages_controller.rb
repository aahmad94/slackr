class Api::DirectmessagesController < ApplicationController
  ...
  def create
    ...
    RoomRelayJob.perform_later(@directmessage_rm, @users)
  ...
  def leave
    ...
    unless @directmessage_rm.users.empty?
      RoomRelayJob.perform_later(@directmessage_rm, @directmessage_rm.users.to_a)
    end
  ...
  def add
    @directmessage_rm = Directmessage.find(params[:room_id])
